...
const TicketCard = ({ ticket }) => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 p-5 rounded-xl border-2 ${priorityColors[ticket.priority]} hover:shadow-lg transition-shadow`}>
      ...
      <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">{ticket.description}</p>
      ...
      <div className="mt-4 flex gap-2">
        <button className="flex-1 px-4 py-2 bg-cyan-500 text-white rounded-lg hover:bg-cyan-600 transition-colors text-sm font-medium">
          Lihat Detail
        </button>
