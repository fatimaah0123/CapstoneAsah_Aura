  ...
  const fetchTickets = async () => {
    ...
    try {
      ...
      const filtered = filterStatus
        ? apiTickets.filter(
            (t) => (t.ticket_status || t.status) === filterStatus
          )
        : apiTickets;
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-gray-500 text-sm">
              Data maintenance realtime dari Database.
            </p>
          </div>
          {/* <button 
            ...
            {loading ? (
              ...
              <div className="text-center py-10 border-2 border-dashed border-gray-200 rounded-xl">
                <p className="text-gray-500">
                  Tidak ada tiket ditemukan untuk status ini.
                </p>
              </div>
            ) : (
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4 w-full md:w-auto">
                      <div
                        className={`p-3 rounded-full shrink-0 ${getStatusColor(
                          status
                        )}`}
                      >
                        {status === 'RESOLVED' ? (
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto justify-end border-t md:border-t-0 pt-3 md:pt-0 mt-2 md:mt-0 border-gray-100">
                      ...
                      {status === 'OPEN' && (
                        <button
                          onClick={(e) =>
                            handleStatusChange(e, ticketId, 'IN_PROGRESS')
                          }
                      ...
                      {status === 'IN_PROGRESS' && (
                        <button
                          onClick={(e) =>
                            handleStatusChange(e, ticketId, 'RESOLVED')
                          }
